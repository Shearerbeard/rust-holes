...
run_case stripped-attribution-header attribution "sed -i '' 's/^\*\*Attribution\.\*\*/Credit./' README.md"
...
run_case attribution-moved-down attribution "python3 -c \"import pathlib;p=pathlib.Path('README.md');t=p.read_text();p.write_text(t.replace('**Attribution.**','Note.',1)+'\\n**Attribution.** later.\\n')\""
