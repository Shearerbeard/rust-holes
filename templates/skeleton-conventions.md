...
line. The rules behind these conventions are in the `typed-holes` skill,
mapped in `../PLAYBOOK.md`; this file is the per-module statement of how
they were applied. When you copy this file, record `copied from
